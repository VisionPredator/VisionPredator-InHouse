...
void RenderPass::BindStatic(std::shared_ptr<ModelData> curModel)
{
	std::shared_ptr<Device> Device = m_Device.lock();
...
void RenderPass::BindSkeletal(std::shared_ptr<ModelData> curModel, std::shared_ptr<Mesh> mesh)
{
	std::shared_ptr<Device> Device = m_Device.lock();
