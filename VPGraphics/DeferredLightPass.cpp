	...
	const std::shared_ptr<ResourceManager>& resourceManager)
{
	...
	m_PS = m_ResourceManager.lock()->Get<PixelShader>(L"MeshDeferredLight");
	m_VS = m_ResourceManager.lock()->Get<VertexShader>(L"Quad");

	m_QuadVB = m_ResourceManager.lock()->Get<VertexBuffer>(L"Quard_VB");
	m_QuadIB = m_ResourceManager.lock()->Get<IndexBuffer>(L"Quard_IB");
}
