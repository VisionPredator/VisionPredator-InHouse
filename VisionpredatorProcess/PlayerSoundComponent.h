...
#include <Component.h>
	 ...
	 public Component
 {
	 ...
	 VP_JSONBODY(PlayerSoundComponent, Volume_Walk, Volume_Run, Volume_Jump, Volume_Slide, Volume_Sit, Volume_Hurt, Volume_Death, Volume_Dash, Volume_Transformation, Volume_GunDraw, Volume_GunThrow
		 , Volume_Sword1, Volume_Sword2, Volume_Sword3, Volume_VPAttack1, Volume_VPAttack2, SoundKey_Walk1, SoundKey_Walk2, SoundKey_Run1, SoundKey_Run2, SoundKey_Jump, SoundKey_Slide, SoundKey_Sit, SoundKey_Hurt, SoundKey_Death, SoundKey_GunDraw, SoundKey_GunThrow,SoundKey_Sword1, SoundKey_Sword2, SoundKey_Sword3, SoundKey_Dash, SoundKey_Transformation);
	 int Volume_Walk{ 25 };
	 int Volume_Run{ 25 };
	 int Volume_Jump{ 40 };
