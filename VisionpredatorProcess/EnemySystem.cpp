...
void EnemySystem::DetectTarget(EnemyComponent& enemyComp, float deltaTime)
{
	...
	isInNoiseRange = noiseRange.Contains(playerPos) && (m_PlayerComp->CurrentFSM == VisPred::Game::PlayerFSM::RUN) || (m_PlayerComp->CurrentFSM == VisPred::Game::PlayerFSM::JUMP) ? true : false;	// 최적화 필요.
