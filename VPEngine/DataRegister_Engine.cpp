...
void EngineRegister::Register_Components()
{
	...
	META_ADD_COMP(MeshComponent, MeshComponent::IsVisible, MeshComponent::IsOverDraw,MeshComponent::FBX,MeshComponent::LightMapOffset, MeshComponent::LightMapTiling,MeshComponent::LightMapScale, MeshComponent::LightMapIndex, MeshComponent::MaskColor,MeshComponent::InteractiveColor, MeshComponent::isPunch);
