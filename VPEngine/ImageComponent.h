...
struct ImageComponent : Component
{
	...
	VP_JSONBODY(ImageComponent, RenderMode, Billboard, TexturePath, PosXPercent, PosYPercent, Scale, Layer, Color, LeftPercent, RightPercent, TopPercent, BottomPercent);
