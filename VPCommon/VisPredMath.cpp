...
namespace VisPred
{
	namespace SimpleMath
	{
		...
		const Matrix VisPred::SimpleMath::Matrix::Identity = { 1.f, 0.f, 0.f, 0.f,
										  0.f, 1.f, 0.f, 0.f,
										  0.f, 0.f, 1.f, 0.f,
										  0.f, 0.f, 0.f, 1.f };
		...
		int Random_int(int min, int max) noexcept
		{
			...
			// Create a distribution for integer numbers between min and max
...
using namespace VisPred::SimpleMath;
...
static_assert(sizeof(VisPred::SimpleMath::Viewport) == sizeof(D3D11_VIEWPORT), "Size mismatch");
static_assert(offsetof(VisPred::SimpleMath::Viewport, x) == offsetof(D3D11_VIEWPORT, TopLeftX), "Layout mismatch");
static_assert(offsetof(VisPred::SimpleMath::Viewport, y) == offsetof(D3D11_VIEWPORT, TopLeftY), "Layout mismatch");
static_assert(offsetof(VisPred::SimpleMath::Viewport, width) == offsetof(D3D11_VIEWPORT, Width), "Layout mismatch");
static_assert(offsetof(VisPred::SimpleMath::Viewport, height) == offsetof(D3D11_VIEWPORT, Height), "Layout mismatch");
static_assert(offsetof(VisPred::SimpleMath::Viewport, minDepth) == offsetof(D3D11_VIEWPORT, MinDepth), "Layout mismatch");
static_assert(offsetof(VisPred::SimpleMath::Viewport, maxDepth) == offsetof(D3D11_VIEWPORT, MaxDepth), "Layout mismatch");
#endif
